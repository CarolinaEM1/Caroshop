<?php
include (__DIR__ . '/admin/cliente.class.php');
$web = new Cliente();
$datos = $web->getAll();
?>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Basic example">
                <a href="admin/cliente.php?action=update&id_cliente=<?php echo $dato['id_cliente']; ?>"
                  class="btn btn-primary">Actualizar</a>
                <a href="admin/cliente.php?action=delete&id_cliente=<?php echo $dato['id_cliente']; ?>"
