<?php
include (__DIR__ . '/admin/empleado.class.php');
$web = new Empleado();
$datos = $web->getAll();
?>
...
.icon-box input[type="number"] {
  ...
  margin-bottom: 10px;
  padding: 5px;
  border: 1px solid #f8b7c9; /* Rosa claro */
  border-radius: 5px;
}
...
.icon-box input[type="submit"]:hover {
  background-color: #d1456d; /* Rosa oscuro */
}
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Basic example">
                <a href="admin/producto.php?action=update&id_empleado=<?php echo $dato['id_empleado']; ?>"
                  class="btn btn-primary">Actualizar</a>
                <a href="admin/producto.php?action=delete&id_empleado=<?php echo $dato['id_empleado']; ?>"
